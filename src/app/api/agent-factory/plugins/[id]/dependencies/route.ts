...
import * as schema from '@agentic-sdk/db/database-schema';
...
export async function GET(
  ...
  try {
    ...
    const dependencyTree: DependencyTreeNode[] = extracted.plugins.map((c: any) => ({ type: c.type, name: c.name, depth: 1 }));
